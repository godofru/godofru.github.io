...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["I am A Student.", "I Study in major Information Technology .", "I studied at Rajamangala University of Bangkok."],    /* You can change the home section typing text from
